...
parser.add_argument('--path', type=str, help='Assing path to root element where program starts searching for keys. Syntax: parent.child.child. If not defined, document root used as root element.')
